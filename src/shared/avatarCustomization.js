...
export const CHARACTERS = [
  { id: 'unicorn', name: 'Luna l’aventurière', gender: 'girl', emoji: '🦄', skin: '#f2c7a5', hair: '#5b2d90', outfit: '#ff5fa2', accent: '#ffe066', requiredLevel: 1, cost: 0 },
  { id: 'butterfly', name: 'Nova l’astronaute', gender: 'girl', emoji: '🦋', skin: '#9b5f3f', hair: '#241c2b', outfit: '#f5f7ff', accent: '#6c63ff', requiredLevel: 2, cost: 20 },
  { id: 'cat', name: 'Kira la ninja', gender: 'girl', emoji: '🐱', skin: '#d99b72', hair: '#17151e', outfit: '#343047', accent: '#ff4d6d', requiredLevel: 3, cost: 30 },
  { id: 'dog', name: 'Milo le sportif', gender: 'boy', emoji: '🐶', skin: '#f0b98d', hair: '#7a431f', outfit: '#20b486', accent: '#ffffff', requiredLevel: 4, cost: 40 },
  { id: 'fox', name: 'Zélie l’exploratrice', gender: 'girl', emoji: '🦊', skin: '#e8ad83', hair: '#d45b32', outfit: '#f2a93b', accent: '#315f49', requiredLevel: 5, cost: 50 },
  { id: 'panda', name: 'Aya la magicienne', gender: 'girl', emoji: '🐼', skin: '#70402f', hair: '#251713', outfit: '#7656c8', accent: '#ffd166', requiredLevel: 6, cost: 60 },
  { id: 'lion', name: 'Léo le chevalier', gender: 'boy', emoji: '🦁', skin: '#c9855d', hair: '#8b4d20', outfit: '#718096', accent: '#3c91e6', requiredLevel: 7, cost: 70 },
  { id: 'koala', name: 'Lou la scientifique', gender: 'girl', emoji: '🐨', skin: '#f4c9a8', hair: '#c89b6d', outfit: '#e8f5ff', accent: '#00a6a6', requiredLevel: 8, cost: 80 },
  { id: 'dragon', name: 'Sasha la pirate', gender: 'girl', emoji: '🐉', skin: '#8f563d', hair: '#151515', outfit: '#b23a48', accent: '#f4d35e', requiredLevel: 9, cost: 100 },
  ...
  { id: 'zoe-hero', name: 'Zoé l’héroïne', gender: 'girl', emoji: '🦸‍♀️', skin: '#6f402f', hair: '#201927', outfit: '#3d6fe0', accent: '#ffcf4a', requiredLevel: 12, cost: 160 },
  { id: 'ines-adventurer', name: 'Inès l’exploratrice', gender: 'girl', emoji: '🧭', skin: '#efb58a', hair: '#743a24', outfit: '#2f7d63', accent: '#f5c451', requiredLevel: 13, cost: 190 },
  { id: 'rose-princess', name: 'Rose la gardienne des étoiles', gender: 'girl', emoji: '👸', skin: '#ba775b', hair: '#3a2028', outfit: '#e66dad', accent: '#ffe08a', requiredLevel: 14, cost: 220 },
  { id: 'jade-dancer', name: 'Jade la danseuse', gender: 'girl', emoji: '💃', skin: '#7d4a37', hair: '#16131c', outfit: '#e24d72', accent: '#ffc6dd', requiredLevel: 15, cost: 260 },
  { id: 'alba-elf', name: 'Alba la gardienne', gender: 'girl', emoji: '🧝‍♀️', skin: '#f0c29e', hair: '#d8e7ef', outfit: '#5371b8', accent: '#b7f2d5', requiredLevel: 16, cost: 300 },
];
...
export const HATS = [
  ...
  { id: 'headphones', name: 'Casque audio', emoji: '🎧', requiresAnyOf: [], requiredLevel: 4 },
...
export const CAPES = [
  ...
  { id: 'jetpack', name: 'Réacteur dorsal', emoji: '🚀', requiresAnyOf: ['mastery-temps'] },
...
export const HAIRSTYLES = [
  { id: 'original-hair', name: 'Coiffure d’origine', emoji: '✨', color: null, requiredLevel: 1 },
  ...
  { id: 'starlight-ponytail', name: 'Queue étoilée', emoji: '🌟', color: '#7c4dcc', requiredLevel: 9 },
  { id:'fairy-braid',name:'Tresse féerique',emoji:'🧚',color:'#9b62c7',requiredLevel:4 },
  { id:'rider-braid',name:'Tresse cavalière',emoji:'🐴',color:'#6b3f2b',requiredLevel:4 },
  { id:'fossil-bob',name:'Carré d’aventurière',emoji:'🦖',color:'#9a4f2d',requiredLevel:5 },
  { id:'cupcake-curls',name:'Boucles de pâtissière',emoji:'🧁',color:'#d66f9c',requiredLevel:3 },
  { id:'ocean-waves',name:'Vagues océanes',emoji:'🌊',color:'#176f91',requiredLevel:6 },
  { id:'funfair-tails',name:'Couettes de fête',emoji:'🎡',color:'#e64f91',requiredLevel:4 },
  { id:'festival-hair',name:'Mèches de festival',emoji:'🎸',color:'#7d4bd1',requiredLevel:7 },
  { id:'detective-bob',name:'Carré de détective',emoji:'🕵️',color:'#4b3028',requiredLevel:6 },
  { id:'camping-braid',name:'Tresse de randonnée',emoji:'🏕️',color:'#7a482c',requiredLevel:5 },
  { id:'dream-clouds',name:'Nuages de rêve',emoji:'☁️',color:'#b999e8',requiredLevel:8 },
  { id:'spring-crown-hair',name:'Couronne printanière',emoji:'🌸',color:'#8b5b36',requiredLevel:3 },
  { id:'summer-bun',name:'Chignon d’été',emoji:'🏖️',color:'#c98345',requiredLevel:5 },
  { id:'academy-braids',name:'Tresses d’académie',emoji:'🎒',color:'#3e2b56',requiredLevel:7 },
  { id:'birthday-curls',name:'Boucles de fête',emoji:'🎂',color:'#f06ba6',requiredLevel:4 },
  { id:'champion-ponytail',name:'Queue de championne',emoji:'🏆',color:'#5a3423',requiredLevel:6 },
];

export const OUTFITS = [
  { id: 'original-outfit', name: 'Tenue d’origine', emoji: '✨', outfit: null, accent: null, requiredLevel: 1 },
  { id: 'school', name: 'Tenue d’école', emoji: '📚', outfit: '#315f8c', accent: '#f7d154', requiredLevel: 1 },
  { id: 'sport', name: 'Tenue de sport', emoji: '🏅', outfit: '#20b486', accent: '#ffffff', requiredLevel: 1 },
  ...
  { id: 'royal', name: 'Tenue royale', emoji: '👑', outfit: '#a855f7', accent: '#fde68a', requiredLevel: 8 },
  { id: 'dragon-rider', name: 'Dresseuse de dragon', emoji: '🐲', outfit: '#315f49', accent: '#ff7b54', requiredLevel: 9 },
  { id: 'galaxy', name: 'Tenue galaxie', emoji: '🌌', outfit: '#27265b', accent: '#8be9fd', requiredLevel: 10 },
  { id: 'rainbow', name: 'Tenue arc-en-ciel', emoji: '🌈', outfit: '#ef476f', accent: '#ffd166', requiredLevel: 12 },
  { id: 'witch', name: 'Tenue de sorcière', emoji: '🧹', outfit: '#3d2c5f', accent: '#ff9f1c', requiredLevel: 6 },
  ...
  { id: 'snow-queen', name: 'Reine de l’hiver', emoji: '❄️', outfit: '#9adcf8', accent: '#f7fbff', requiredLevel: 6 },
  ...
  { id:'fairy-dress',name:'Robe des fées',emoji:'🧚',outfit:'#a86bdd',accent:'#a8f0dc',requiredLevel:4 },
  { id:'rider-uniform',name:'Cavalière de concours',emoji:'🐴',outfit:'#31506d',accent:'#f2d08b',requiredLevel:4 },
  { id:'paleontologist',name:'Paléontologue',emoji:'🦖',outfit:'#ba7a3d',accent:'#5f7f4d',requiredLevel:5 },
  { id:'pastry-chef',name:'Pâtissière enchantée',emoji:'🧁',outfit:'#fff0f6',accent:'#ed78a8',requiredLevel:3 },
  { id:'ocean-princess',name:'Princesse des océans',emoji:'🐚',outfit:'#159a9c',accent:'#b7f5e7',requiredLevel:6 },
  { id:'funfair-star',name:'Étoile de la fête',emoji:'🎡',outfit:'#ef5c9c',accent:'#ffe16b',requiredLevel:4 },
  { id:'rock-star',name:'Star du festival',emoji:'🎸',outfit:'#5334a2',accent:'#ff6faf',requiredLevel:7 },
  { id:'detective-coat',name:'Détective',emoji:'🕵️',outfit:'#76513b',accent:'#e6c68d',requiredLevel:6 },
  { id:'camping-explorer',name:'Tenue d’exploratrice',emoji:'🏕️',outfit:'#3e7d57',accent:'#f0c45b',requiredLevel:5 },
  { id:'dream-pajamas',name:'Pyjama des rêves',emoji:'☁️',outfit:'#8c78d4',accent:'#d9ceff',requiredLevel:8 },
  { id:'spring-dress',name:'Robe du printemps',emoji:'🌸',outfit:'#64a86b',accent:'#ffd1e3',requiredLevel:3 },
  { id:'summer-dress',name:'Robe d’été',emoji:'🏖️',outfit:'#f18b62',accent:'#ffe59a',requiredLevel:5 },
  { id:'fantasy-uniform',name:'Uniforme fantastique',emoji:'🎒',outfit:'#384b82',accent:'#d5b9ff',requiredLevel:7 },
  { id:'birthday-dress',name:'Robe d’anniversaire',emoji:'🎂',outfit:'#e45d9e',accent:'#ffe174',requiredLevel:4 },
  { id:'champion-kit',name:'Tenue de championne',emoji:'🏆',outfit:'#2477c8',accent:'#ffd34e',requiredLevel:6 },
];
...
export const COMPANIONS = [
  ...
  { id:'griffin-companion',name:'Plume le griffon',emoji:'🦅',requiredLevel:4 },
  { id:'pony-companion',name:'Praline le poney',emoji:'🐴',requiredLevel:4 },
  { id:'dino-companion',name:'Dino le bébé saurien',emoji:'🦕',requiredLevel:5 },
  { id:'baker-cat-companion',name:'Moka le chat pâtissier',emoji:'🐱',requiredLevel:3 },
  { id:'seahorse-companion',name:'Perle l’hippocampe',emoji:'🐠',requiredLevel:6 },
  { id:'teddy-companion',name:'Pompon l’ourson',emoji:'🧸',requiredLevel:4 },
  { id:'music-fox-companion',name:'Tempo le renard',emoji:'🦊',requiredLevel:7 },
  { id:'detective-hamster',name:'Loupe le hamster',emoji:'🐹',requiredLevel:6 },
  { id:'bear-companion',name:'Miel le petit ours',emoji:'🐻',requiredLevel:5 },
  { id:'cloud-sheep',name:'Coton le mouton',emoji:'🐑',requiredLevel:8 },
  { id:'bee-companion',name:'Miel l’abeille',emoji:'🐝',requiredLevel:3 },
  { id:'turtle-companion',name:'Lagune la tortue',emoji:'🐢',requiredLevel:5 },
  { id:'school-owl-companion',name:'Sage le petit hibou',emoji:'🦉',requiredLevel:7 },
  { id:'party-dragon-companion',name:'Confetti le dragon',emoji:'🐲',requiredLevel:4 },
  { id:'sport-mascot-companion',name:'Flash la mascotte',emoji:'🐯',requiredLevel:6 },
];
...
export const COMPANION_ACCESSORIES = [
  ...
  { id:'pet-fairy-crown',name:'Couronne de feuilles',emoji:'🌿',requiredLevel:4 },
  { id:'pet-rider-ribbon',name:'Ruban de concours',emoji:'🎗️',requiredLevel:4 },
  { id:'pet-fossil',name:'Petit fossile',emoji:'🦴',requiredLevel:5 },
  { id:'pet-cupcake',name:'Mini cupcake',emoji:'🧁',requiredLevel:3 },
  { id:'pet-shell',name:'Coquillage nacré',emoji:'🐚',requiredLevel:6 },
  { id:'pet-balloon',name:'Ballon de fête',emoji:'🎈',requiredLevel:4 },
  { id:'pet-guitar',name:'Mini guitare',emoji:'🎸',requiredLevel:7 },
  { id:'pet-magnifier',name:'Loupe secrète',emoji:'🔍',requiredLevel:6 },
  { id:'pet-lantern',name:'Lanterne de camping',emoji:'🏮',requiredLevel:5 },
  { id:'pet-moon',name:'Lune moelleuse',emoji:'🌙',requiredLevel:8 },
  { id:'pet-bee-flower',name:'Fleur de printemps',emoji:'🌺',requiredLevel:3 },
  { id:'pet-sunglasses',name:'Lunettes de soleil',emoji:'😎',requiredLevel:5 },
  { id:'pet-book',name:'Livre enchanté',emoji:'📖',requiredLevel:7 },
  { id:'pet-party-hat',name:'Chapeau de fête',emoji:'🥳',requiredLevel:4 },
  { id:'pet-medal',name:'Médaille dorée',emoji:'🥇',requiredLevel:6 },
];
...
export const AVATAR_PACKS = [
  ...
  {
    id: 'space-pack', name: 'Mission spatiale', emoji: '🚀', requiredLevel: 10, cost: 220,
  ...
  {
    id: 'escape-decor-pack', name: 'Escapades et détente', emoji: '🏝️', requiredLevel: 5, cost: 100, decorPack: true,
    description: 'Lagon, jardin zen et coucher de soleil pour voyager.',
    itemIds: ['ocean-lagoon', 'zen-garden', 'sunset-beach'],
  },
  { id:'fairy-kingdom-pack',name:'Royaume des fées',emoji:'🧚',requiredLevel:4,cost:120,description:'Une aventure lumineuse au cœur du peuple des fées.',itemIds:['fairy-braid','fairy-dress','griffin-companion','pet-fairy-crown','fairy-village','magic-waterfall'] },
  { id:'equestrian-pack',name:'Académie équestre',emoji:'🐴',requiredLevel:4,cost:125,description:'En selle pour les promenades et les concours.',itemIds:['rider-braid','rider-uniform','pony-companion','pet-rider-ribbon','royal-stable','horse-meadow'] },
  { id:'dinosaur-pack',name:'Monde des dinosaures',emoji:'🦖',requiredLevel:5,cost:135,description:'Fossiles, jungle et découvertes préhistoriques.',itemIds:['fossil-bob','paleontologist','dino-companion','pet-fossil','prehistoric-jungle','fossil-museum'] },
  { id:'bakery-pack',name:'Pâtisserie enchantée',emoji:'🧁',requiredLevel:3,cost:100,description:'Des créations sucrées dans une boutique magique.',itemIds:['cupcake-curls','pastry-chef','baker-cat-companion','pet-cupcake','magic-kitchen','cake-shop'] },
  { id:'underwater-pack',name:'Royaume sous-marin',emoji:'🌊',requiredLevel:6,cost:155,description:'Explore les récifs et le palais des océans.',itemIds:['ocean-waves','ocean-princess','seahorse-companion','pet-shell','underwater-palace','coral-reef'] },
  { id:'funfair-pack',name:'Fête foraine',emoji:'🎡',requiredLevel:4,cost:115,description:'Manèges, lumières et jeux pleins de couleurs.',itemIds:['funfair-tails','funfair-star','teddy-companion','pet-balloon','ferris-wheel','fairground-arcade'] },
  { id:'music-festival-pack',name:'Festival de musique',emoji:'🎸',requiredLevel:7,cost:180,description:'Monte sur scène avec un groupe étincelant.',itemIds:['festival-hair','rock-star','music-fox-companion','pet-guitar','festival-stage','backstage'] },
  { id:'mystery-agency-pack',name:'Agence des mystères',emoji:'🕵️',requiredLevel:6,cost:160,description:'Résous des énigmes dans des lieux secrets.',itemIds:['detective-bob','detective-coat','detective-hamster','pet-magnifier','mystery-manor','secret-lab'] },
  { id:'camping-pack',name:'Aventure en camping',emoji:'🏕️',requiredLevel:5,cost:135,description:'Une escapade sous les étoiles avec les animaux.',itemIds:['camping-braid','camping-explorer','bear-companion','pet-lantern','forest-camp','starry-tent'] },
  { id:'dream-kingdom-pack',name:'Royaume des rêves',emoji:'☁️',requiredLevel:8,cost:195,description:'Voyage parmi les nuages, la lune et les étoiles.',itemIds:['dream-clouds','dream-pajamas','cloud-sheep','pet-moon','cloud-castle','giant-moon'] },
  { id:'spring-garden-pack',name:'Jardin du printemps',emoji:'🐝',requiredLevel:3,cost:95,seasonal:true,description:'Fleurs, abeilles et couleurs du printemps.',itemIds:['spring-crown-hair','spring-dress','bee-companion','pet-bee-flower','flower-garden','magic-greenhouse'] },
  { id:'summer-holiday-pack',name:'Vacances d’été',emoji:'🏖️',requiredLevel:5,cost:140,seasonal:true,description:'Soleil, plage et aventures tropicales.',itemIds:['summer-bun','summer-dress','turtle-companion','pet-sunglasses','summer-pool','tropical-island'] },
  { id:'fantasy-school-pack',name:'Rentrée fantastique',emoji:'🎒',requiredLevel:7,cost:175,seasonal:true,description:'Une école où chaque cours devient magique.',itemIds:['academy-braids','fantasy-uniform','school-owl-companion','pet-book','magic-school','enchanted-library'] },
  { id:'birthday-pack',name:'Anniversaire magique',emoji:'🎂',requiredLevel:4,cost:110,seasonal:true,description:'Ballons, gâteaux et surprises pour faire la fête.',itemIds:['birthday-curls','birthday-dress','party-dragon-companion','pet-party-hat','birthday-room','surprise-party'] },
  { id:'champions-pack',name:'Les championnes',emoji:'🏆',requiredLevel:6,cost:165,description:'Entraînement, courage et podium doré.',itemIds:['champion-ponytail','champion-kit','sport-mascot-companion','pet-medal','champion-stadium','golden-podium'] },
];
...
export const DECORS = [
  ...
  { id: 'candy-clouds', name: 'Nuages de bonbons', gradient: ['#8c66c7', '#f390c0', '#ffd6a5'], requiredLevel: 4 },
  ...
  { id:'fairy-village',name:'Village des fées',gradient:['#31583f','#78bd75','#e4b8ff'],requiredLevel:4 },
  { id:'magic-waterfall',name:'Cascade magique',gradient:['#214d69','#54c9c2','#cfb6ff'],requiredLevel:4 },
  { id:'royal-stable',name:'Écurie royale',gradient:['#60452f','#bb8b55','#f2d7a2'],requiredLevel:4 },
  { id:'horse-meadow',name:'Prairie équestre',gradient:['#4b8d62','#9bcf76','#87c8e8'],requiredLevel:4 },
  { id:'prehistoric-jungle',name:'Jungle préhistorique',gradient:['#214f39','#568f45','#d1a94c'],requiredLevel:5 },
  { id:'fossil-museum',name:'Musée des fossiles',gradient:['#5c4939','#b69b73','#e6d7ba'],requiredLevel:5 },
  { id:'magic-kitchen',name:'Cuisine enchantée',gradient:['#d77ba3','#ffd2df','#fff0bc'],requiredLevel:3 },
  { id:'cake-shop',name:'Boutique de gâteaux',gradient:['#bd5d91','#f5a9c8','#88d4c2'],requiredLevel:3 },
  { id:'underwater-palace',name:'Palais sous-marin',gradient:['#063f69','#087fa4','#53dbc0'],requiredLevel:6 },
  { id:'coral-reef',name:'Récif corallien',gradient:['#075b7c','#20b7ba','#ff8e8e'],requiredLevel:6 },
  { id:'ferris-wheel',name:'Grande roue',gradient:['#53338c','#d84f9b','#ffce58'],requiredLevel:4 },
  { id:'fairground-arcade',name:'Arcade foraine',gradient:['#28204f','#8c3ec0','#31d7c1'],requiredLevel:4 },
  { id:'festival-stage',name:'Scène du festival',gradient:['#25164d','#7f42c8','#ff5fa2'],requiredLevel:7 },
  { id:'backstage',name:'Coulisses étoilées',gradient:['#17182d','#41446f','#e282bc'],requiredLevel:7 },
  { id:'mystery-manor',name:'Manoir mystérieux',gradient:['#212735','#53606b','#9a8054'],requiredLevel:6 },
  { id:'secret-lab',name:'Laboratoire secret',gradient:['#182d35','#276e70','#65d8bd'],requiredLevel:6 },
  { id:'forest-camp',name:'Camp en forêt',gradient:['#173d31','#3f7951','#d99c4b'],requiredLevel:5 },
  { id:'starry-tent',name:'Tente sous les étoiles',gradient:['#131c3d','#334b79','#f0b75b'],requiredLevel:5 },
  { id:'cloud-castle',name:'Château des nuages',gradient:['#7376c9','#b9b8ee','#ffe1f3'],requiredLevel:8 },
  { id:'giant-moon',name:'Lune géante',gradient:['#111835','#394881','#d5dcff'],requiredLevel:8 },
  { id:'flower-garden',name:'Jardin fleuri',gradient:['#5b9a63','#e28eb2','#ffe192'],requiredLevel:3 },
  { id:'magic-greenhouse',name:'Serre magique',gradient:['#39765b','#82be79','#ffd1e2'],requiredLevel:3 },
  { id:'summer-pool',name:'Piscine d’été',gradient:['#168db6','#62d4dc','#ffd16f'],requiredLevel:5 },
  { id:'tropical-island',name:'Île tropicale',gradient:['#087f9c','#4acdc4','#ffc268'],requiredLevel:5 },
  { id:'magic-school',name:'École enchantée',gradient:['#2f3769','#7359a6','#d2b77a'],requiredLevel:7 },
  { id:'enchanted-library',name:'Bibliothèque magique',gradient:['#443152','#8b5d72','#d6b76b'],requiredLevel:7 },
  { id:'birthday-room',name:'Salle d’anniversaire',gradient:['#bd5594','#ff94bd','#ffd764'],requiredLevel:4 },
  { id:'surprise-party',name:'Fête surprise',gradient:['#5845a8','#e85ba4','#ffd35e'],requiredLevel:4 },
  { id:'champion-stadium',name:'Stade des championnes',gradient:['#135a8b','#2994c7','#62c873'],requiredLevel:6 },
  { id:'golden-podium',name:'Podium doré',gradient:['#624a8b','#c6923e','#ffe06c'],requiredLevel:6 },
];
