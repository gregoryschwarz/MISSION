...
export const HAIRSTYLES = [
  ...
  { id:'fossil-bob',name:'Carré aventurière',emoji:'🦖',color:'#9a4f2d',requiredLevel:5 },
  { id:'cupcake-curls',name:'Boucles pâtissière',emoji:'🧁',color:'#d66f9c',requiredLevel:3 },
  { id:'ocean-waves',name:'Vagues océanes',emoji:'🌊',color:'#176f91',requiredLevel:6 },
  { id:'funfair-tails',name:'Couettes fête',emoji:'🎡',color:'#e64f91',requiredLevel:4 },
  { id:'festival-hair',name:'Mèches festival',emoji:'🎸',color:'#7d4bd1',requiredLevel:7 },
  { id:'detective-bob',name:'Carré détective',emoji:'🕵️',color:'#4b3028',requiredLevel:6 },
  { id:'camping-braid',name:'Tresse randonnée',emoji:'🏕️',color:'#7a482c',requiredLevel:5 },
...
export const OUTFITS = [
  ...
  { id:'camping-explorer',name:'Exploratrice camping',emoji:'🏕️',outfit:'#3e7d57',accent:'#f0c45b',requiredLevel:5 },
  ...
  { id:'birthday-dress',name:'Robe anniversaire',emoji:'🎂',outfit:'#e45d9e',accent:'#ffe174',requiredLevel:4 },
...
export const COMPANIONS = [
  ...
  { id:'bee-companion',name:'Maya l’abeille',emoji:'🐝',requiredLevel:3 },
  { id:'turtle-companion',name:'Lagune la tortue',emoji:'🐢',requiredLevel:5 },
  { id:'school-owl-companion',name:'Sage le mini hibou',emoji:'🦉',requiredLevel:7 },
...
export const COMPANION_ACCESSORIES = [
  ...
  { id:'pet-lantern',name:'Lanterne camping',emoji:'🏮',requiredLevel:5 },
  { id:'pet-moon',name:'Lune moelleuse',emoji:'🌙',requiredLevel:8 },
  { id:'pet-bee-flower',name:'Fleur de printemps',emoji:'🌺',requiredLevel:3 },
  { id:'pet-sunglasses',name:'Lunettes soleil',emoji:'😎',requiredLevel:5 },
...
export const DECORS = [
  ...
  { id:'birthday-room',name:'Salle anniversaire',gradient:['#bd5594','#ff94bd','#ffd764'],requiredLevel:4 },
