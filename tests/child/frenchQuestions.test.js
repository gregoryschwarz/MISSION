...
describe('French manual catalogue', () => {
  it('contains broad word banks for every difficulty family', () => {
    expect(REGULAR_WORDS.length).toBeGreaterThanOrEqual(23);
    expect(X_PLURAL_WORDS.length).toBeGreaterThanOrEqual(23);
    expect(INVARIABLE_WORDS.length).toBeGreaterThanOrEqual(18);
  });
});
